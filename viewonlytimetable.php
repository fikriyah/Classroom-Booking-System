...
<form method="get"  action="3C2.php">
  
  <input type="hidden" id="classname" name="classname" value="3C1" />
  <input type="hidden" id="username" name="username" value="muhammad" />
  ...
  <body>
    ...
    <table class="table table-bordered table-dark text-center">
      ...
      <div id="container">
        ...
        <div id="right"><button type="submit" name="submit" id="submit" value="submit here"  class="btn btn-primary">BOOK</button></div>
        <div id="center">
            <b style="font-size: 40px">3C - 1 Schedule</b>
            <br>
